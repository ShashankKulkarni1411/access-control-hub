    ...
    extend: {
      ...
      colors: {
        ...
        workspace: {
          ...
          sidebar: "hsl(var(--workspace-sidebar))",
          panel: "hsl(var(--workspace-panel))",
          border: "hsl(var(--workspace-border))",
          text: "hsl(var(--workspace-text))",
          "text-muted": "hsl(var(--workspace-text-muted))",
          accent: "hsl(var(--workspace-accent))",
          success: "hsl(var(--workspace-success))",
          warning: "hsl(var(--workspace-warning))",
          error: "hsl(var(--workspace-error))",
        },
        editor: {
